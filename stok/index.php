...
<body>
    <div class="container mt-5">
        ...
        <h2>Laporan STOK : <?php echo $tgl; ?> </h2>
            ...
            <table id="dataTable" class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-right">update Stok</th>
                ...
                <tbody>
                    ...
                    <?php foreach ($barang as $row): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo number_format($stokfisik, 0, ',', '.'); ?></td>
                            <td>
                                <?php if ($stok == 0): ?>
                            ...
                            <td class="text-right">
                                <!-- Input Stok -->
                                <input type="text" name="stok[<?php echo $row['kd_obat']; ?>]" value="<?php echo number_format($stok, 0, ',', '.'); ?>" class="form-control" step="1">
                            </td>
