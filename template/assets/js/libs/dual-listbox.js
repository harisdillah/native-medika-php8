!(function (t, e) {
    ...
    return (function (t) {
        ...
        "./node_modules/sortablejs/modular/sortable.esm.js": function (
            t,
            e,
            n
        ) {
                    ...
                    if (
                        ...
                        do {
                            if (
                                ...
                                (r -=
                                    f.top + parseInt(x(i, "border-top-width"))),
                                    (l -=
                                        f.left +
                                        parseInt(x(i, "border-left-width"))),
                                    (s = r + a.height),
                                    (c = l + a.width);
                                break;
                            }
            ...
            var Z,
                ...
                Nt = function (t, e) {
                    var n = x(t),
                        ...
                        s =
                            r &&
                            parseInt(r.marginLeft) +
                                parseInt(r.marginRight) +
                                A(i).width,
                        c =
                            l &&
            ...
            function Ht(t, e) {
                ...
                var n = {
                    ...
                    supportPointer:
                        !1 !== Ht.supportPointer && "PointerEvent" in window,
            ...
            (Ht.prototype = {
                ...
                _triggerDragStart: function (t, e) {
                    (e = e || ("touch" == t.pointerType && t)),
                        !this.nativeDraggable || e
                            ...
                            : (g(Z, "dragend", this),
                              g(J, "dragstart", this._onDragStart));
                    try {
                        document.selection
                            ? zt(function () {
                    ...
                    function j(e) {
                        return (
                            ...
                            s.dragoverBubble ||
                                t.rootEl ||
                                l === document ||
                                (Z.parentNode[F]._isOutsideThisEl(t.target),
                                !e && Xt(t)),
                            !s.dragoverBubble &&
                                t.stopPropagation &&
                                t.stopPropagation(),
                ...
                _showClone: function (t) {
                    if ("clone" === t.lastPutMode) {
                        if (ot) {
                            if ((U("showClone", this), Ht.eventCanceled))
                                return;
                ...
                (Ht.mount = function () {
                    ...
                    e[0].constructor === Array && (e = e[0]),
                        e.forEach(function (t) {
                            ...
                            t.utils && (Ht.utils = r({}, Ht.utils, t.utils)),
                                q.mount(t);
                        });
                }),
                                ...
                                (0 == M && 0 == k) ||
                                    ...
                                    (Jt[d].pid = setInterval(
                                        function () {
                                            o &&
                                                0 === this.layer &&
                                                Ht.active._onTouchMove(Qt);
                                            var e = Jt[this.layer].vy
                                                    ? Jt[this.layer].vy * s
                                                    : 0,
                                                n = Jt[this.layer].vx
                                                    ? Jt[this.layer].vx * s
                ...
                return (
                    (t.prototype = {
                        ...
                        dragStartGlobal: function (t) {
                            ...
                            !this.isMultiDrag &&
                                ue &&
                                ue.multiDrag._deselectMultiDrag(),
                        ...
                        (n = [
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    for (
                                        ...
                                        var a = n[i];
                                        -1 ===
                                        a.textContent.toLowerCase().indexOf(o)
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    ...
                                    return (
                                        n.appendChild(t), n.appendChild(e), n
                                    );
                                },
                            },
                            {
                                ...
                                value: function () {
                                    (this.buttons =
                                        ...
                                        this.add_all_button.setAttribute(
                                            "type",
                                            "button"
                                        ),
                                        (this.add_button =
                                            document.createElement("button")),
                                        this.add_button.classList.add(
                                            "dual-listbox__button"
                                        ),
                                        (this.add_button.innerHTML =
                                            this.addButtonText),
                                        this.add_button.setAttribute(
                                            "type",
                                            "button"
                                        ),
                                        (this.remove_button =
                                            document.createElement("button")),
                                        this.remove_button.classList.add(
                                            "dual-listbox__button"
                                        ),
                                        (this.remove_button.innerHTML =
                                            this.removeButtonText),
                                        this.remove_button.setAttribute(
                                            "type",
                                            "button"
                                        ),
                                        ...
                                        (this.remove_all_button.innerHTML =
                                            this.removeAllButtonText),
                                        this.remove_all_button.setAttribute(
                                            "type",
                                            "button"
                                        ),
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return (
                                        ...
                                        t.dataset.order &&
                                            (e.dataset.order = t.dataset.order),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    (this.dualListbox =
                                        ...
                                        this.selectedList.addEventListener(
                                            "end",
                                            function (e) {
                                                e.to === e.from &&
                                                    t.reorder(
